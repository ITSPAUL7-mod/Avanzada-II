...
public class VehiculoService {
    ...
    public void crearVehiculo(Vehiculo vehiculo) {
        ...
        if (vehiculo.getCategoriaVehiculo() == null || vehiculo.getCategoriaVehiculo().getId() == null) {
            throw new WebApplicationException("El ID de la categoría de vehículo es obligatorio", 400);
        }
        ...
        Integer catId = vehiculo.getCategoriaVehiculo().getId();
        CategoriaVehiculo categoria = this.cri.findById(catId); 
        if (categoria == null) {
            throw new WebApplicationException("No existe la categoría de vehículo con ID: " + catId, 404);
        }
    ...
    public void actualizarVehiculo(Vehiculo vehiculo, Integer id) {
        ...
        if (vehiculo.getCategoriaVehiculo() != null && vehiculo.getCategoriaVehiculo().getId() != null) {
            ...
            CategoriaVehiculo categoria = this.cri.findById(catId);
            if (categoria == null) {
                throw new WebApplicationException("No existe la categoría con ID: " + catId, 404);
            }
            base.setCategoriaVehiculo(categoria);
        }
